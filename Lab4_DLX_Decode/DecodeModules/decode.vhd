...
begin
    ...
    rs1_addr <= instruction(25 downto 21);
    rs2_addr <= instruction(20 downto 16); -- Also acts as RD for I-Type
    rd_addr_r <= instruction(15 downto 11);
    ...
    with reg_dest_sel select
        rd_addr_out <= rs2_addr when "00", -- I-Type destination is in rs2 field (20-16)
                       rd_addr_r when "01", -- R-Type destination is in rd field (15-11)
                       "11111"   when "10", -- R31 for JAL
                       "00000"   when others;
